...
./query_irhint.exec -o A                        -r 10 $dfile $qfile       &>> output_eclog
./query_irhint.exec -o B                        -r 10 $dfile $qfile       &>> output_eclog
...
./query_irhint.exec -o A                        -r 10 $dfile $qfile       &>> output_wikipedia
./query_irhint.exec -o B                        -r 10 $dfile $qfile       &>> output_wikipedia
